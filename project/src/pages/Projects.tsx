    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    ...
                    {daysLeft > 0 && (
                      <div className="flex items-center space-x-2 text-gray-700">
                        ...
                        <span className="text-gray-900 font-semibold">{daysLeft} days</span>
                      </div>
                    )}
                  </div>
                </CardContent>
        ...
        <Modal
          ...
          size="xl"
        >
          <form onSubmit={handleSubmit} className="space-y-6 p-6 bg-gradient-to-br from-sky-50 via-blue-100 to-blue-200 rounded-3xl border-2 border-blue-200 shadow-2xl">
