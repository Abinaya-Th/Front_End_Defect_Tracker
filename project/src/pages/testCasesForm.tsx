...
const TestCasesForm: React.FC = () => {
  ...
  const {  addTestCase, updateTestCase, deleteTestCase } = useApp();
  ...
  // Add a dummy releases array for demonstration (replace with real data/fetch as needed)
  const [releases] = useState<{ id: string; name: string; version: string }[]>(
    [
      { id: '1', name: 'Release 1', version: 'v1.0' },
      { id: '2', name: 'Release 2', version: 'v2.0' },
    ]
  );
